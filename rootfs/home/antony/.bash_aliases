...
alias els81man-state='watch -n 10 -dc sudo systemctl status els81-wwan-manager.service'
...
alias plas9man-state='watch -n 10 -dc sudo systemctl status plas9-wwan-manager.service'
